		...
		<footer className="foot">
			<ul className="footer-wrap d-lg-flex">
				...
				<ul className="list-unstyled d-lg-flex ml-auto">
					...
					<img src="images/location-icon.svg" alt="Location icon" className="mr-2 hide-desktop"/>
						<p className="my-auto">1005 Greenbelt Road, Houston TX 50940 USA</p>
					</li>
					<li className="list-unstyled d-md-flex">
						<img src="images/call-icon.svg" alt="Call icon" className="mr-2 hide-desktop"/>
						<p className="my-auto">+234 80 234 5678 | +234 80 234 5678</p>
					</li>
					<li className="list-unstyled d-md-flex">
						<img src="images/email-icon.svg" alt="Email icon" className="my-auto mr-2 hide-desktop"/>
